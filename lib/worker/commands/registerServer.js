...
let serverUtils = require("./../../global/mysql/serverUtils.js");
let userUtils = require("./../../global/mysql/userUtils.js");
let chalk = require("chalk");

module.exports = new Clapp.Command({
    name: "registerServer",
    desc: "Register the server in the database to store rabbitSettings",
    admin: true,
    fn: (argv, context) => {
