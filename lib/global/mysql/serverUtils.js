...
module.exports = {
    ...
    register: function (id, name) {
        ...
        let promise = module.exports.db.query("INSERT INTO servers SET ?", server)
            .then(module.exports.db.query("INSERT INTO rabbitSettings SET ?", welcomeMessage))
            .then(module.exports.db.query("INSERT INTO rabbitSettings SET ?", partMessage));
    ...
    getSetting: function (id, setting) {
        ...
        return module.exports.db.query("SELECT value FROM rabbitSettings WHERE serverId = ? AND setting = ?", [server.serverId, server.setting])
            .then((results) => {
