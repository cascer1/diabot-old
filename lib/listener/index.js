...
let app = new Clapp.App({
    ...
    onReply: (message, context) => {
        console.log("ERROR: entered Clapp onReply function!");
    }
});
...
rabbit.configure(rabbitSettings).done(function () {
    ...
    fs.readdirSync("./lib/global/commands/").forEach((file) => {
        app.addCommand(require("./../global/commands/" + file));
    });

    console.log("Loading events");
    fs.readdirSync("./lib/global/events/").forEach((file) => {
        require("./../global/events/" + file);
    });
