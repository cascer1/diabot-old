...
module.exports = {
    ...
    register: function (id, name) {
        ...
        let promise = module.exports.db.query('INSERT INTO servers SET ?', server)
            .done(module.exports.db.query('INSERT INTO settings SET ?', welcomeMessage))
            .done(module.exports.db.query('INSERT INTO settings SET ?', partMessage));

        for(let i = 0; i < defaultTypes.length; i++) {
            promise.done(module.exports.db.query('INSERT INTO types SET ?', defaultTypes[i]));
        }
